...
# File Names #
fig1name = '../Data/saved_figures/Air_hBN_BP_SiO2_Si_Ap_ac_image-' + str(wavelength) + imageFileType
fig2name = '../Data/saved_figures/Air_hBN_BP_SiO2_Si_Ap_zz_image-' + str(wavelength) + imageFileType
################################################################################
################################################################################
...
################################################################################
################################################################################
np.savetxt('../Data/saved_files/Air_hBN_BP_SiO2_Si_Ap_ac_imageData-' + str(wavelength) + 'nm.txt', Ap_ac_image)
np.savetxt('../Data/saved_files/Air_hBN_BP_SiO2_Si_Ap_zz_imageData-' + str(wavelength) + 'nm.txt', Ap_zz_image)
np.savetxt('../Data/saved_files/Air_hBN_BP_SiO2_Si-BP_thickness-' + str(wavelength) + 'nm.txt', BP_thickness_array)
np.savetxt('../Data/saved_files/Air_hBN_BP_SiO2_Si-hBN_thickness-' + str(wavelength) + 'nm.txt', hBN_thickness_array)
################################################################################
################################################################################
